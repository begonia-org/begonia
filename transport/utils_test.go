...
func TestNewEndpoint(t *testing.T) {
	...
	c.Convey("TestNewEndpoint", t, func() {
		for _, testCase := range cases {
			enps, err := transport.NewLoadBalanceEndpoint(loadbalance.BalanceType(testCase.name), testCase.endpoints)
...
func TestJSONCamelCase(t *testing.T) {
	c.Convey("TestJSONCamelCase", t, func() {
		c.So(transport.JSONCamelCase("testCase"), c.ShouldEqual, "testCase")
		c.So(transport.JSONCamelCase("testcasetest"), c.ShouldEqual, "testcasetest")
		c.So(transport.JSONCamelCase("test_case_test_test"), c.ShouldEqual, "testCaseTestTest")
		c.So(transport.JSONCamelCase("test_case_test_test_test"), c.ShouldEqual, "testCaseTestTestTest")
	})
}