...
type GreeterClient interface {
	// Sends a greeting
	SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*v1.APIResponse, error)
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*v1.APIResponse, error) {
...
func (x *greeterSayHelloStreamReplyClient) Recv() (*v1.APIResponse, error) {
	m := new(v1.APIResponse)
...
func (c *greeterClient) SayHelloBidiStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloBidiStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[1], Greeter_SayHelloBidiStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greeterSayHelloBidiStreamClient) Recv() (*v1.APIResponse, error) {
	m := new(v1.APIResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreeterServer interface {
	// Sends a greeting
	SayHello(context.Context, *HelloRequest) (*v1.APIResponse, error)
...
func (UnimplementedGreeterServer) SayHello(context.Context, *HelloRequest) (*v1.APIResponse, error) {
...
func (x *greeterSayHelloStreamReplyServer) Send(m *v1.APIResponse) error {
...
func (x *greeterSayHelloBidiStreamServer) Send(m *v1.APIResponse) error {
	return x.ServerStream.SendMsg(m)
}
