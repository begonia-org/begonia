...
func TestNewEndpoint(t *testing.T) {
	...
	c.Convey("TestNewEndpoint", t, func() {
		for _, testCase := range cases {
			enps, err := gateway.NewLoadBalanceEndpoint(loadbalance.BalanceType(testCase.name), testCase.endpoints)
...
func TestJSONCamelCase(t *testing.T) {
	c.Convey("TestJSONCamelCase", t, func() {
		c.So(gateway.JSONCamelCase("testCase"), c.ShouldEqual, "testCase")
		c.So(gateway.JSONCamelCase("testcasetest"), c.ShouldEqual, "testcasetest")
		c.So(gateway.JSONCamelCase("test_case_test_test"), c.ShouldEqual, "testCaseTestTest")
		c.So(gateway.JSONCamelCase("test_case_test_test_test"), c.ShouldEqual, "testCaseTestTestTest")
	})
}
