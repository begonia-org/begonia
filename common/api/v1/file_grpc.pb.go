...
const (
	FileService_UploadFile_FullMethodName = "/wetrycode.begonia.common.api.v1.FileService/UploadFile"
)
...
func (x *fileServiceUploadFileClient) CloseAndRecv() (*UploadAPIResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(UploadAPIResponse)
...
func (x *fileServiceUploadFileServer) SendAndClose(m *UploadAPIResponse) error {
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wetrycode.begonia.common.api.v1.FileService",
